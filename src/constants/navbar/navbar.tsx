    ...
    return (
        <div className="navbar-container">
            <div className="navbar">
                ...
                <ul className="links">
                    <NavLink className="li" to="travel-deals">Travel deals</NavLink>
                    <li
                    ...
                    >
                        ...
                        {destinationsDropdownOpen && (
                            <div className="dropdown-content">
                                <NavLink to="destination1" className="dropdown-link">Destination 1</NavLink>
                                <NavLink to="destination2" className="dropdown-link">Destination 2</NavLink>
                            </div>
                        )}
                    </li>
                    <li
                    ...
                    >
                        ...
                        {travelStylesDropdownOpen && (
                            <div className="dropdown-content">
                                <NavLink to="style1" className="dropdown-link">Style 1</NavLink>
                                <NavLink to="style2" className="dropdown-link">Style 2</NavLink>
                            </div>
                        )}
                    </li>
